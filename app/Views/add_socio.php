                                ...
                                <div class="form-body">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-5 form-group">
                                            <?php echo form_input(array('name' => 'nombre', 'class' => 'form-control', 'type' => 'text','required'=>true )); ?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Apellido') ?>
                                        </div>
                                        <div class="col-md-5 form-group">
                                            <?php echo form_input(array('name' => 'apellido', 'class' => 'form-control', 'type' => 'text','required'=>true)); ?> </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Documento') ?>
                                        </div>
                                        <div class="col-md-5 form-group">
                                            <?php echo form_input(array('name' => 'documento', 'class' => 'form-control', 'type' => 'number','minlength'=>7,'maxlength'=>8,'required'=>true ,'size'=>1)); ?> </div>
                                        <div class="col-md-6">
                                            <?php echo form_label('Celular') ?>
                                        </div>
                                        <div class="col-md-5 form-group">
                                            <?php echo form_input(array('name' => 'celular', 'class' => 'form-control', 'type' => 'number','minlength'=>10,'maxlength'=>10,'required'=>true ,'size'=>1)); ?> </div>
