...
use function PHPSTORM_META\type;
 ...
 echo base_url(); ?>/Ingresos" class="btn btn-danger ">Atras</a>
        </div>
    </header>
    <div id="main-content">
                ...
                <div class=" col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title text-center">Agregar Ingreso</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <?php
                                echo form_open('/Ingresos/add', array('class' => 'form form-horizontal')) ?>
                                <div class="form-body">
